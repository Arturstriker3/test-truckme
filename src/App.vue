...
<template>
  <header>
    <div class="container" >
      <nav>
        <div class="logo">
          <img src="./assets/images/logo_truck_me_frete_plataforma.png" alt="truckme-logo">
        </div>
    ...
    <section class="home" ref="home" >
      <div class="container">
        <div class="content">
          <div class="text-card">
            <div class="txt">
              <h4>Solução Inteligente em Frete</h4>
...
main {
  ...
  .home {
    ...
    .container {
      ...
      background-image: url("./assets/images/banner_truck_me.jpeg");
